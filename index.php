        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Te invitamos a conocer nuestra línea de productos.</h3>
                </div>
                <div class="row">
                    ...
                    <div class="text-center">
                        <h2 class="section-heading text-uppercase">Productos acá</h2>
                        <h3 class="section-subheading text-muted">Te invitamos a conocer nuestra línea de productos.</h3>
                    </div>
        ...
        <section class="page-section" id="about">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Historia, compromiso y visión.</h3>
                </div>
                <ul class="timeline">
                    <li>
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body"><p class="text-muted">LEMAVII, una empresa que nace de la idea de Leonardo Guarco, logrando crear un emprendimiento de desarrollo electrónico dedicado a resolver conflictos con sistemas de baja y alta tensión, es así como a fines de 2021 forma una sociedad junto a el Ing Matias Pierdominici, expandiendo el área de desarrollo a productos personalizados y pensados para cada usuario, contando igual con una línea homóloga para los problemas triviales.</p></div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4 class="subheading">En repaso</h4>
                            </div>
                            <div class="timeline-body"><p class="text-muted">La empresa está dedicada a fabricar y comercializar una amplia gama de productos tecnologicos , entre los cuales se encuentran detectores de baja, media y alta tensión, perfiladores, automatismos como tableros, sistemas inalambricos y desarrollos a pedido del usuario.</p></div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body"><p class="text-muted">En LEMAVII  nos comprometemos a brindar los más altos estándares de calidad y servicio acorde al nivel de las mejores multinacionales, con los mejores tiempos de entrega, precios y respuestas acordes a las necesidades de cada cliente.</p></div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body"><p class="text-muted">Nuestra visión es clara y consiste en mejorar la tecnología con la que las empresas Argentinas trabajan día a día y representar una marca de confianza a la hora elegirnos.</p></div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
        ...
        <section class="page-section bg-light" id="equipo">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Podés contactarte con cualquera de nosotros!</h3>
                </div>
                <div class="row">
                    <div class="col-lg-4">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="assets/img/team/4.jpg" alt="..." />
                            <h4>Leonardo Guarco</h4>
                            <p class="text-muted">Director tecnico</p>
                            <a class="btn btn-dark btn-social mx-2" href="#!" aria-label="Leonardo Guarco"><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-dark btn-social mx-2" href="#!" aria-label="Leonardo Guarco"><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-dark btn-social mx-2" href="#!" aria-label="Leonardo Guarco"><i class="fab fa-linkedin-in"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="assets/img/team/5.jpg" alt="..." />
                            <h4>ING Matias Pierdominici</h4>
                            <p class="text-muted">Desarrollador</p>
                            <a class="btn btn-dark btn-social mx-2" href="#!" aria-label="Matias Pierdominici"><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-dark btn-social mx-2" href="#!" aria-label="Matias Pierdominici"><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-dark btn-social mx-2" href="#!" aria-label="Matias Pierdominici"><i class="fab fa-linkedin-in"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="assets/img/team/6.jpg" alt="..." />
                            <h4>Carlos Paretto</h4>
                            <p class="text-muted">Ingeniero en ingenierias</p>
                            <a class="btn btn-dark btn-social mx-2" href="#!" aria-label="Victor Polo"><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-dark btn-social mx-2" href="#!" aria-label="Victor Polo"><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-dark btn-social mx-2" href="#!" aria-label="Victor Polo"><i class="fab fa-linkedin-in"></i></a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center"><p class="large text-muted">Seguinos en nuestras redes y mira los ultimos avances de nuestra compania.</p>
                        <p class="large text-muted">"El desarrollo progresivo del hombre depende vitalmente de la invención; es el producto más importante de su cerebro creativo" -Nikola Tesla</p>
                    </div>
                </div>
            </div>
        </section>
